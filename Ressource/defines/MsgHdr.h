...
#define PACKETTYPE_SEND_TO_SERVER_CHANGEJOB		(DWORD)0x00000f32  
#define PACKETTYPE_SEND_TO_SERVER_AP			(DWORD)0x00000f33  
#define PACKETTYPE_CHANGEJOB					(DWORD)0x00000f34  
#define PACKETTYPE_ITEM_TBL_UPDATE				(DWORD)0x00000f35  
...
#define PACKETTYPE_NW_WANTED_GOLD			(DWORD)0x00ff00ef	
#define PACKETTYPE_NW_WANTED_LIST			(DWORD)0x00ff00f0   
#define PACKETTYPE_WN_WANTED_LIST			(DWORD)0x00ff00f1   
#define PACKETTYPE_NW_WANTED_INFO			(DWORD)0x00ff00f2   
#define PACKETTYPE_WN_WANTED_INFO			(DWORD)0x00ff00f3   

#define PACKETTYPE_WC_WANTED_GOLD			(DWORD)0x00ff00f4	
#define PACKETTYPE_WC_WANTED_REWARD			(DWORD)0x00ff00f5	
#define PACKETTYPE_CW_WANTED_LIST			(DWORD)0x00ff00f6	
#define PACKETTYPE_CW_WANTED_REWARD			(DWORD)0x00ff00f7	

#define PACKETTYPE_CT_WANTED				(DWORD)0x00ff00f8	
#define PACKETTYPE_TC_LIST					(DWORD)0x00ff00f9	
#define PACKETTYPE_REQ_LEAVE				(DWORD)0x00ff00fa	
#define PACKETTYPE_WT_REQ_LEAVE				(DWORD)0x00ff00fb	
#define PACKETTYPE_NW_WANTED_NAME			(DWORD)0x00ff00fc	
#define PACKETTYPE_WN_WANTED_NAME			(DWORD)0x00ff00fd	
...
#define PACKETTYPE_BLOCK			(DWORD)0xffffff5a	
...
#define PACKETTYPE_CD_GUILD_LOGO			(DWORD)0xf000b016	
...
#define PACKETTYPE_GUILD_PENYA				(DWORD)0xf000b027	
#define PACKETTYPE_GUILD_DB_REALPENYA		(DWORD)0xf000b028	
...
#define	PACKETTYPE_DECL_GUILD_WAR			(DWORD)0xf000b036	
#define	PACKETTYPE_ACPT_GUILD_WAR			(DWORD)0xf000b037	
#define PACKETTYPE_NC_ADDVOTE				(DWORD)0xf000b038	
#define PACKETTYPE_NC_REMOVEVOTE			(DWORD)0xf000b039	
#define PACKETTYPE_NC_CLOSEVOTE				(DWORD)0xf000b03a	
#define PACKETTYPE_NC_CASTVOTE				(DWORD)0xf000b03b	

#define PACKETTYPE_CD_ADDVOTE				(DWORD)0xf000b03c   
#define PACKETTYPE_CD_REMOVEVOTE			(DWORD)0xf000b03d	
#define PACKETTYPE_CD_CLOSEVOTE				(DWORD)0xf000b03e	
#define PACKETTYPE_CD_CASTVOTE				(DWORD)0xf000b03f	
#define PACKETTYPE_DC_ADDVOTERESULT			(DWORD)0xf000b040	
#define PACKETTYPE_CW_ADDVOTERESULT			(DWORD)0xf000b041	
#define PACKETTYPE_CW_MODIFYVOTE			(DWORD)0xf000b042	

#define PACKETTYPE_UPDATE_GUILD_RANKING		(DWORD)0xf000b043	
#define PACKETTYPE_UPDATE_GUILD_RANKING_END	(DWORD)0xf000b044	
#define PACKETTYPE_UPDATE_GUILD_RANKING_DB	(DWORD)0xf000b04d	
#define PACKETTYPE_REQUEST_GUILD_RANKING	(DWORD)0xf000b04e	

#define	PACKETTYPE_WAR_DEAD		(DWORD)0Xf000b045	
#define	PACKETTYPE_WAR_END	(DWORD)0xf000b046	
#define	PACKETTYPE_SURRENDER	(DWORD)0xf000b047	
#define	PACKETTYPE_QUERY_TRUCE	(DWORD)0xf000b048	
#define	PACKETTYPE_ACPT_TRUCE	(DWORD)0xf000b049	
#define	PACKETTYPE_WAR_TIMEOUT	(DWORD)0xf000b04a	
#define	PACKETTYPE_WAR_MASTER_ABSENT	(DWORD)0xf000b04b	
...
#define PACKETTYPE_CHANGE_ATTRIBUTE (DWORD)0xf000d00e 
...
#define SNAPSHOTTYPE_GUILD_LOGO		(WORD)0x00fb				
...
#define SNAPSHOTTYPE_GUILD_PENYA		(WORD)0x00ff			
#define SNAPSHOTTYPE_GUILD_REAL_PENYA	(WORD)(0x00D5)		
#define SNAPSHOTTYPE_GUILD_CHANGEJOBLEVEL	(WORD)(0x00D6)	
#define SNAPSHOTTYPE_GUILD_ADDVOTE		(WORD)(0x00D8)	
#define SNAPSHOTTYPE_GUILD_MODIFYVOTE   (WORD)(0x00D9)	
#define	SNAPSHOTTYPE_WAR	(WORD)0x00da	
...
#define ERROR_BILLING_INFO_FAILED			126L	
#define ERROR_BILLING_DATABASE_ERROR		127L	
#define ERROR_BILLING_TIME_OVER				128L	
#define ERROR_BILLING_OTHER_ERROR			129L	
#define ERROR_BILLING_DISCONNECTED			130L	
...
#define	PN_DBSRVR_1		24000	
#define PN_DBSRVR_2		7200	
...
const BYTE ACCOUNT_BILLING_INFO_FAILED    = 4;	
const BYTE ACCOUNT_BILLING_DATABASE_ERROR = 5;	
const BYTE ACCOUNT_BILLING_TIME_OVER      = 6;	
const BYTE ACCOUNT_BILLING_OTHER_ERROR    = 7;	
const BYTE ACCOUNT_BILLING_DISCONNECTED	  = 8;  
const BYTE ACCOUNT_IPCUT_ADDR	  = 9;  

const BYTE ACCOUNT_BILLING_WAIT_ACK	      = 128;  




const BYTE ACCOUNT_FLAG_18           = 0x01;		
const BYTE ACCOUNT_FLAG_SCHOOLEVENT  = 0x02;		
const BYTE ACCOUNT_FLAG_UNREGISTER18 = 0x04;		
const BYTE ACCOUNT_FLAG_HANGAME		 = 0x08;		
...
const BYTE CT_WANTED_REQ_LIST   = 0x00;		
const BYTE CT_WANTED_SET		= 0x01;		
#endif 
...
const BYTE GC_GETPENYAGUILD		= 0x40;		
const BYTE GC_GETPENYAPLAYER	= 0x41;		
...
const BYTE LOG_SKILLPOINT_GET_QUEST	= 0x00;		
const BYTE LOG_SKILLPOINT_GET_HUNT	= 0x01;		
const BYTE LOG_SKILLPOINT_USE		= 0x10;		

const BYTE PK_PINK					= 0x00;		
const BYTE PK_PROPENSITY			= 0x01;		
const BYTE PK_PKVALUE				= 0x02;		


const BYTE ANGEL_INFO				= 0x01;		

const BYTE TEXT_GENERAL				= 0x01;		
const BYTE TEXT_DIAG				= 0x02;		
